...
export type AgentCreateRequest = AgentRecord;

export type AgentUpdateRequest = Partial<Omit<AgentRecord, "id">>;
...
export interface ApiClient {
	...
	deleteAgent(agentId: string, options?: HealthRequestOptions): Promise<void>;
